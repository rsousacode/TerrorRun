class Credits
{
  private PVector return2menuPos, titlePos, creditsPos;
  private int pixelRadius;
  Credits ()
  {
    creditsPos = new PVector(width/2, 1 * height/1.6);
  ...
  void displayImages() {
    ...
    image(assetManager.creditsScript(), creditsPos.x, creditsPos.y, width/3, height/1.5);
  }
  void display()
  {
    displayImages();
